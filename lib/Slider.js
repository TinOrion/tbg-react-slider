...
var Slider = function (_React$Component) {
  ...
  _createClass(Slider, [{
    ...
    value: function getViewportDimensions() {
      console.log('this.refs.viewport_active: ', this.refs.viewport_active);
      console.log('findDOMNode(this.refs.viewport_active): ', findDOMNode(this.refs.viewport_active));
      return {
    ...
    value: function getActiveStyle() {
      if (!this.state.active) {
        return (0, _objectAssign2.default)(this.props.transition.end(this.state.direction, this.state.viewport.active), this.props.transition.transition(this.props.transitionTime));
      }
    ...
    value: function getLastStyle() {
      if (!this.state.active) {
        return (0, _objectAssign2.default)(this.props.transition.prevEnd(this.state.direction, this.state.viewport.last), this.props.transition.transition(this.props.transitionTime), _Style2.default.lastView);
      }
      return (0, _objectAssign2.default)(this.props.transition.prevStart(this.state.direction, this.state.viewport.last), _Style2.default.lastView);
    }
  }, {
    key: 'getNextItem',
